...
- (CWStatusBarNotification *)init
{
    ...
    if (self) {
        ...
        self.swipeGestureRecognizer = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(dismissNotificationSwiped:)];
        [self.swipeGestureRecognizer setDirection:UISwipeGestureRecognizerDirectionUp];
        ...
        self.notificationDismissedBlock = ^(void) {
...
- (void)dismissNotificationSwiped:(UISwipeGestureRecognizer*)recognizer
{
    [self.notificationDismissedBlock invoke];
}
